...
<div class="cart_totals <?php echo (WC()->customer->has_calculated_shipping()) ? 'calculated_shipping' : ''; ?>">
	...
	<h2>
		<?php esc_html_e('Cart totals', 'pavlin'); ?>
	</h2>
	...
	<table cellspacing="0" class="shop_table shop_table_responsive">
		...
		<tr class="cart-subtotal">
			...
			<td data-title="<?php esc_attr_e('Subtotal', 'pavlin'); ?>">
		...
		<?php elseif (WC()->cart->needs_shipping() && 'yes' === get_option('woocommerce_enable_shipping_calc')): ?>
			...
			<tr class="shipping">
				<th>
					<?php esc_html_e('Shipping', 'pavlin'); ?>
				</th>
				<td data-title="<?php esc_attr_e('Shipping', 'pavlin'); ?>">
		...
		if (wc_tax_enabled() && !WC()->cart->display_prices_including_tax()) {
			...
			if (WC()->customer->is_customer_outside_base() && !WC()->customer->has_calculated_shipping()) {
				...
				$estimated_text = sprintf(' <small>' . esc_html__('(estimated for %s)', 'pavlin') . '</small>', WC()->countries->estimated_for_prefix($taxable_address[0]) . WC()->countries->countries[$taxable_address[0]]);
			}
		...
		<tr class="order-total">
			<th>
				<?php esc_html_e('Total', 'pavlin'); ?>
			</th>
			<td data-title="<?php esc_attr_e('Total', 'pavlin'); ?>">
